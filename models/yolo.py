...
try:
    ...
    from processor.pipeline.detection.yolov5.utils.torch_utils import time_synchronized, fuse_conv_and_bn, \
        model_info, scale_img, initialize_weights, select_device, copy_attr
